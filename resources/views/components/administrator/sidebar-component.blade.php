            ...
            <ul class="main-menu">
                ...
                <li class="slide has-sub">
                    <a href="javascript:void(0);" class="side-menu__item">
                        ...
                        <span class="side-menu__label">Dashboards<span class="badge bg-warning-transparent ms-2 d-inline-block">12</span></span>
                ...
                <li class="slide">
                    <a href="widgets.html" class="side-menu__item">
                        ...
                        <span class="side-menu__label">Widgets<span class="badge bg-danger-transparent ms-2 d-inline-block">Hot</span></span>
                    </a>
                </li>
                <!-- End::slide -->
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child2">
                                ...
                                <li class="slide">
                                    <a href="form_dateTime_pickers.html" class="side-menu__item">Date,color Picker</a>
                                </li>
                            </ul>
                        </li>
                        <li class="slide">
                ...
                <li class="slide has-sub">
                    <a href="javascript:void(0);" class="side-menu__item">
                        ...
                        <span class="side-menu__label">Tables<span class="badge bg-success-transparent ms-2 d-inline-block">3</span></span>
                    </a>
                    <ul class="slide-menu child1">
                        <li class="slide side-menu__label1">

...
<body>
    ...
    <div class="page">
        <!-- app-header -->
        <x-administrator.header-component></x-administrator.header-component>
        <!-- /app-header -->

        <!-- Start::app-sidebar -->
        <x-administrator.sidebar-component></x-administrator.sidebar-component>
        <!-- End::app-sidebar -->
        ...
        <!-- Footer Start -->
        <x-administrator.footer-component></x-administrator.footer-component>
        <!-- Footer End -->

$(function(e) {
	...
	var confirmation = "Apakah Kamu Yakin ?";
    var warning = "Data yang telah di hapus tidak dapat dikembalikan lagi!";
    var yes_sure = "Ok";
		...
		swal({
		  ...
		  function(isConfirm) {
			if (isConfirm) {
			  ...
			  swal("Membatalkan", "Hapus Data telah di batalkan", "error");
			}
		  });

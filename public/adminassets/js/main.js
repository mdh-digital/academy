(function () {
    ...
    function localStorageBackup() {
        ...
        if (localStorage.mdhlayout) {
            let html = document.querySelector('html');
            let layoutValue = localStorage.getItem('mdhlayout');
            html.setAttribute('data-nav-layout', 'horizontal');
            setTimeout(() => {
                clearNavDropdown();
            }, 5000);
        ...
        if (localStorage.mdhverticalstyles) {
            let html = document.querySelector('html');
            let verticalStyles = localStorage.getItem('mdhverticalstyles');

            if (verticalStyles == 'closed') {
                html.setAttribute('data-vertical-style', 'closed');
                localStorage.removeItem("mdhnavstyles")
            }
        ...
        if (localStorage.mdhnavstyles) {
            let html = document.querySelector('html');
            let navStyles = localStorage.getItem('mdhnavstyles');
            if (navStyles == 'menu-click') {
                html.setAttribute('data-nav-style', 'menu-click');
                localStorage.removeItem("mdhverticalstyles");
        ...
        if (localStorage.mdhclassic) {
            let html = document.querySelector('html');
            html.setAttribute('data-page-style', 'classic');
        }
        if (localStorage.mdhboxed) {
            let html = document.querySelector('html');
            html.setAttribute('data-width', 'boxed');
        }
        if (localStorage.mdhheaderfixed) {
            let html = document.querySelector('html');
            html.setAttribute('data-header-position', 'fixed');
        }
        if (localStorage.mdhheaderscrollable) {
            let html = document.querySelector('html');
            html.setAttribute('data-header-position', 'scrollable');
        }
        if (localStorage.mdhheaderrounded) {
            let html = document.querySelector('html');
            html.setAttribute('data-header-position', 'rounded');
        }
        if (localStorage.mdhmenufixed) {
            let html = document.querySelector('html');
            html.setAttribute('data-menu-position', 'fixed');
        }
        if (localStorage.mdhmenuscrollable) {
            let html = document.querySelector('html');
            html.setAttribute('data-menu-position', 'scrollable');
        }
        if (localStorage.mdhMenu) {
            let html = document.querySelector('html');
            let menuValue = localStorage.getItem('mdhMenu');
            switch (menuValue) {
                case 'light':
        ...
        if (localStorage.mdhHeader) {
            let html = document.querySelector('html');
            let headerValue = localStorage.getItem('mdhHeader');
            switch (headerValue) {
                case 'dark':
                    html.setAttribute('data-header-styles', 'dark');
        ...
        if (localStorage.mdhDefaultHeader) {
            let html = document.querySelector('html');
            let defaultHeaderValue = localStorage.getItem('mdhDefaultHeader');

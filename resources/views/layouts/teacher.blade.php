...
<body>
    ...
    <div class="page">
        <!-- app-header -->
        <x-teacher.header-component></x-teacher.header-component>
        <!-- /app-header -->

        <!-- Start::app-sidebar -->
        <x-teacher.sidebar-component></x-teacher.sidebar-component>
        <!-- End::app-sidebar -->
        ...
        <!-- Footer Start -->
        <x-teacher.footer-component></x-teacher.footer-component>
        <!-- Footer End -->
